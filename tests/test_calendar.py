...
async def test_add_historical_events():
    async with async_session_maker() as session:
        historical_events_data = [
            ...
            {"id": 2, "name": "Основание Парижа римлянами", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 2"},
            {"id": 3, "name": "Осада Парижа", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 3"},
            {"id": 4, "name": "Постройка Эйфелевой башни", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 4"},
            {"id": 5, "name": "Взятие Парижа во время Столетней войны", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 5"},
            {"id": 6, "name": "Революция 1830 года в Париже", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 6"},
            {"id": 7, "name": "Парижская коммуна", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 7"},
            {"id": 8, "name": "Строительство Лувра", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 8"},
            {"id": 9, "name": "Первый международный фестиваль кино в Париже", "event_date": datetime.date(1111, 7, 14),
             "event_description": "test event_description 9"},
            {"id": 10, "name": "Битва при Турской площади", "event_date": datetime.date(1111, 7, 14),
